...
d3.csv("./static/data/merged_final.csv").then(function(ufoData, err) {
  if (err) throw err;
  ...
  var fireballLabel = xlabelsGroup.append("text")
    ...
    .classed("active", true)
    .text("Number of Fireball Sightings");
  ...
  var lightLabel = xlabelsGroup.append("text")
    ...
    .text("Number of Light Formation Sightings");
    ...
    .classed("inactive", true)
    .text("Number of Triangle Sightings");
